...
const ContactFormSection = () => {
    ...
    return (
        <div
            id="form"
            className="bg-black text-white w-full px-4 md:px-14 md:py-28 py-20 flex lg:flex-row flex-col gap-5 md:gap-14 relative justify-between overflow-hidden z-0"
        >
