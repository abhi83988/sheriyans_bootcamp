    ...
    <section className="relative py-12 overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 py-20 grid grid-cols-1 md:grid-cols-3 gap-15">
        {stats.map((stat, i) => (
          <div
            key={i}
            className="flex flex-col items-start justify-center p-19 rounded-lg bg-[#E8F5FB]  transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:scale-105"
          >
